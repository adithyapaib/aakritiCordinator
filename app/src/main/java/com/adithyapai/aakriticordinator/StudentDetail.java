...
public class StudentDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"DefaultLocale", "SetTextI18n"}) StringRequest stringRequest = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                if (Integer.parseInt(paid) >= 300) {
                    ...
                    imageView.setClipToOutline(true);
                    imgsrc = "https://aakriti23.canaraengineering.in/user_images/" + jsonObject.getString("photo");
                    Picasso.get().load(imgsrc).into(imageView);
                    email = jsonObject.getString("email");
                    name = jsonObject.getString("Name");
                    phone = jsonObject.getString("phone");
                    ...
                    pending = jsonObject.getString("pending");
                    id = String.format("%05d", Integer.parseInt(jsonObject.getString("id")));
                    String formattedText = "  <h2> ID: AAK" + id + "</h2>\n" + "  Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + name + "  <br />\n" + "  Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + email + "  <br />\n" + "  Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href=tel:" + phone + ">" + phone + "</a>" + "  <br />\n" + "  Institute:&nbsp;&nbsp;" + inst.substring(0, 20) + "  <br />\n" + "  Course:&nbsp;&nbsp;" + course + "  <br />\n" + "  USN:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + usn.toUpperCase(Locale.ROOT) + "  <br />\n" + "  Branch:&nbsp;&nbsp;" + branch + "  <br />\n" + "  Paid:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + paid + "  <br />\n" + "  Pending:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + pending;
